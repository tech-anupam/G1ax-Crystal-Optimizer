...
public final class HoverEventResolver {
    ...
    public static HoverEvent createShowTextHoverEvent(Component text) {
        try {
            Class<?> actionClass;
            try {
                actionClass = Class.forName("net.minecraft.network.chat.HoverEvent$Action");
            ...
            try {
                showTextClass = Class.forName("net.minecraft.network.chat.HoverEvent$ShowText");
            } catch (ClassNotFoundException e) {
                try {
                    showTextClass = Class.forName("net.minecraft.network.chat.HoverEvent$ItemStackInfo");
